							...
							<div class="col-12">
								...
								<form class="form-horizontal" id="postForm" method="POST" action="{{ url()->current() }}" enctype="multipart/form-data">
									...
									<fieldset>
										...
										<!-- UPDATE BEGIN -->
										<input type="hidden" id="suggested" value="{{ t('suggested') }}">
										<div class="form-group row required">
											<label for="currency" class="col-md-3 col-form-label{{ $parentIdError }}">{{ t('currency') }} <sup>*</sup></label>
											<div class="col-md-8">
												<select name="currency" id="currency" class="form-control selecter{{ $parentIdError }}">
													<option value="0" data-type=""> {{ t('Select a currency') }} </option>
													<option value="USD"
													...
													>{{t('real')}}</option>
													<option value="CLP"
														@if ($post->currency == 'CLP')
															selected="selected"
														@endif
													>{{t('chilean peso')}}</option>
													<option value="ARS"
														@if ($post->currency == 'ARS')
															selected="selected"
														@endif
													>{{t('argentine peso')}}</option>
												</select>
												<input type="hidden" name="parent_type" id="parentType" value="{{ old('parent_type') }}">
											</div>
										</div>
										<div id="priceBloc" class="form-group row required">
											<label class="col-md-3 col-form-label" for="amount">{{ t('amount') }} <sup>*</sup></label>
												...
												<div class="input-group-append">
													<span class="input-group-text">
														<input id="negotiable" name="negotiable" type="checkbox"
															   value="1" {{ (($post->negotiable)=='1') ? 'checked="checked"' : '' }}>&nbsp;<small>{{ t('Negotiable') }}</small>
													</span>
												</div>
												<small style="width:100%;" id="" class="form-text text-muted">{{ t('total amount from currency you want to sell') }}</small>
											</div>
										</div>
										<div id="dollarBlock" class="form-group row">
											<label class="col-md-3 col-form-label" for="USD">{{ t('Price') }}</label>
											<div class="input-group col-md-8">
												...
												<input id="USD"
													   ...
													   class="form-control{{ $priceError }}"
													   type="text" 
													   value="{{ old('price', $post->price_usd) }}"
												>
												
												<div class="input-group-append">
													<span class="input-group-text">
														<input id="negotiable" name="negotiable_usd" type="checkbox"
															   value="1" {{ (($post->negotiable_usd)=='1') ? 'checked="checked"' : '' }}>&nbsp;<small>{{ t('Negotiable') }}</small>
													</span>
												</div>
											</div>
										</div>
										<div id="euroBlock" class="form-group row">
											<label class="col-md-3 col-form-label" for="EUR">{{ t('Price') }}</label>
											<div class="input-group col-md-8">
												<div class="input-group-prepend">
												...
												<input id="EUR"
													   ...
													   class="form-control{{ $priceError }}"
													   type="text"
													   value="{{ old('price', $post->price_eur) }}"
												>
												
												<div class="input-group-append">
													<span class="input-group-text">
														<input id="negotiable" name="negotiable_eur" type="checkbox"
															   value="1" {{ (($post->negotiable_eur)=='1') ? 'checked="checked"' : '' }}>&nbsp;<small>{{ t('Negotiable') }}</small>
													</span>
												</div>
											</div>
										</div>
										<div id="realBlock" class="form-group row">
											<label class="col-md-3 col-form-label" for="BRL">{{ t('Price') }}</label>
											<div class="input-group col-md-8">
												<div class="input-group-prepend">
												...
												<input id="BRL"
													   ...
													   class="form-control{{ $priceError }}"
													   type="text"
													   value="{{ old('price', $post->price_brl) }}"
												>
												
												<div class="input-group-append">
													<span class="input-group-text">
														<input id="negotiable" name="negotiable_brl" type="checkbox"
															   value="1" {{ (($post->negotiable_brl)=='1') ? 'checked="checked"' : '' }}>&nbsp;<small>{{ t('Negotiable') }}</small>
													</span>
												</div>
											</div>
										</div>
										<div id="chileanPesoBlock" class="form-group row">
											<label class="col-md-3 col-form-label" for="CLP">{{ t('Price') }}</label>
											<div class="input-group col-md-8">
												<div class="input-group-prepend">
												...
												<input id="CLP"
													   ...
													   class="form-control{{ $priceError }}"
													   type="text"
													   value="{{ old('price', $post->price_clp) }}"
												>
												
												<div class="input-group-append">
													<span class="input-group-text">
														<input id="negotiable" name="negotiable_clp" type="checkbox"
															   value="1" {{ (($post->negotiable_clp)=='1') ? 'checked="checked"' : '' }}>&nbsp;<small>{{ t('Negotiable') }}</small>
													</span>
												</div>
											</div>
										</div>
										<div id="argentinianPesoBlock" class="form-group row">
											<label class="col-md-3 col-form-label" for="ARS">{{ t('Price') }}</label>
											<div class="input-group col-md-8">
												<div class="input-group-prepend">
												...
												<input id="ARS"
													   ...
													   class="form-control{{ $priceError }}"
													   type="text"
													   value="{{ old('price', $post->price_ars) }}"
												>
												
												<div class="input-group-append">
													<span class="input-group-text">
														<input id="negotiable" name="negotiable_ars" type="checkbox"
															   value="1" {{ (($post->negotiable_ars)=='1') ? 'checked="checked"' : '' }}>&nbsp;<small>{{ t('Negotiable') }}</small>
													</span>
												</div>
											</div>
										</div>
