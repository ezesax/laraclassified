...
class EditController extends FrontController
{
    ...
    public function postForm($postId, PostRequest $request)
    {
		...
		$post->negotiable_usd = $request->input('negotiable_usd');
		$post->negotiable_eur = $request->input('negotiable_eur');
		$post->negotiable_brl = $request->input('negotiable_brl');
		$post->negotiable_clp = $request->input('negotiable_clp');
		$post->negotiable_ars = $request->input('negotiable_ars');
